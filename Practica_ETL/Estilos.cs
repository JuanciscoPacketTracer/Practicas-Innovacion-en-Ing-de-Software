...
namespace Practica_ETL
{
    public class Estilos
    {
        ...
        public static Font FuenteNormal = new Font("Segoe UI", 14);
        public static Font FuenteBold = new Font("Segoe UI", 14, FontStyle.Bold);
        public static Font FuenteTitulo = new Font("Segoe UI", 24, FontStyle.Bold);
        ...
        public static void EstilizarPictureBox(PictureBox pb)
        {
            ...
            pb.Paint += (s, e) => {
                using (Pen pen = new Pen(Acento, 2))
